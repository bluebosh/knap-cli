...
var rootCmd = &cobra.Command{
  Use:   "knap",
  Short: "knap (Knative application platform command line",
  Long: `knap-cli is used to create and manage knap application easily`,
...
func initConfig() {
  if cfgFile != "" {
    ...
    // Search config in home directory with name ".knap" (without extension).
    viper.AddConfigPath(home)
    viper.SetConfigName(".knap")
  }
